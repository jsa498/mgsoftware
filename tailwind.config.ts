...
const config = {
  ...
  theme: {
    ...
    extend: {
      colors: { // Using CSS variables defined in globals.css
        ...
        destructive: {
          ...
          // Assuming you might add this variable in globals.css later if needed
      ...
      animation: {
       ...
       fontFamily: { // Link Geist fonts defined in layout.tsx
