  ...
  mishrat: [
    {
      ...
      origin: "Mixture of Gauri (serious) and Deepak (gentle evening raag)",
    ...
    },
    {
      ...
      origin: "Mixture of Gauri (gravity) and Purbi/Poorvi (twilight raag)",
    ...
    },
    {
      ...
      origin: "Mixture of Gauri (serene) with Guarairi (Marwa-ang variant)",
    ...
    },
    {
      ...
      origin: "Mixture of Gauri (serious) and Chaiti (spring folk melody)",
    ...
    },
    {
      ...
      origin: "Mixture of Gauri (steady) and Bairagan (Bairagi-Bhairav detachment vibe)",
    ...
    },
    {
      ...
      origin: "Combination of Gauri with Poorbi (Poorvi) and Deepak influences",
    ...
    },
    {
      ...
      origin: "Mixture of Gauri (serious) and Majh (folk raag by Guru Arjan Dev Ji)",
    ...
    },
    {
      ...
      origin: "Mixture of Gauri with Malva folk style (influenced by Poorvi, Marwa, and Purvi-Dhanashri raags)",
    ...
    },
    {
      ...
      origin: "Mixture of Gauri with Bhairavi & Bhairav (Bhairavi in lower part, Bhairav in upper):contentReference[oaicite:114]{index=114}",
    ...
    },
    {
      ...
      origin: "Mixture of Gauri (grave) and Sorath (enthusiastic devotion)",
    ...
    },
    {
      ...
      origin: "Mixture of Asa (pre-dawn devotion) and Kafi (evening folk melody):contentReference[oaicite:117]{index=117}",
    ...
    },
    {
      ...
      origin: "Mixture of Asa (early morning) and Asavari (late morning raag) – sometimes termed Asavari Sudh-ang",
    ...
    },
    {
      ...
      origin: "Mixture of Tilang (night raag of yearning) and Kafi (folk mode):contentReference[oaicite:120]{index=120}",
    ...
    },
    {
      ...
      origin: "Mixture of Suhi (joyous love) and Kafi (folk serenity)",
    ...
    },
    {
      ...
      origin: "Mixture of Suhi (joy) and Lalit (intense dawn raag with twin-Madhyams)",
    ...
    },
    {
      ...
      origin: "Mixture of Bilawal (full major scale) and Gond (a folk-raag flavor):contentReference[oaicite:124]{index=124}",
    ...
    },
    {
      ...
      origin: "Mixture of Maru (martial, bold) and Kafi (light, sweet) raags",
    ...
    },
    {
      ...
      origin: "Mixture of Basant (spring raag) and Hindol (morning raag)",
    ...
    },
    {
      ...
      origin: "Mixture of Kalyan (Yaman – evening raga of devotion) and Bhopali (pentatonic raga)",
    ...
    },
    {
      ...
      origin: "Mixture of Parbhati (devotional dawn raag) and Bibhas (morning raag of resolve)",
    ...
    },
    {
      ...
      origin: "Mixture of Bibhas (austere morning raag) and Parbhati (devotional dawn raag)",
